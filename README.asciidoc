== forge-mp-config
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The forge-mp-config addon enables blah blah...)
...
----
<dependency>
   <groupId>org.forge.mp.config</groupId>
   <artifactId>forge-mp-config</artifactId>
